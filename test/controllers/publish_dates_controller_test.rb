...
class PublishDatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publish_date" do
    assert_difference('PublishDate.count') do
      post publish_dates_url, params: { publish_date: { published_at: @publish_date.published_at } }
    end
  ...
  test "should update publish_date" do
    patch publish_date_url(@publish_date), params: { publish_date: { published_at: @publish_date.published_at } }
